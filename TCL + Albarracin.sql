...
-- Concede permisos de solo lectura al usuario1 en todas las tablas de la base de datos "nombre_basedatos"
GRANT SELECT ON nombre_basedatos.* TO 'usuario1'@'localhost';

-- Evita que el usuario1 pueda eliminar registros
REVOKE DELETE ON nombre_basedatos.* FROM 'usuario1'@'localhost';

-- Concede permisos de lectura, inserción y modificación de datos al usuario2 en todas las tablas de la base de datos "nombre_basedatos"
GRANT SELECT, INSERT, UPDATE ON nombre_basedatos.* TO 'usuario2'@'localhost';

-- Evita que el usuario2 pueda eliminar registros
REVOKE DELETE ON nombre_basedatos.* FROM 'usuario2'@'localhost';


-- Iniciar una transacción de la columna "pedidos"
START TRANSACTION;

SELECT * FROM pedidos

-- Realizar la eliminación de registros con una condición
-- DELETE FROM pedidos
-- WHERE LENGTH(id_orden) > 10000;
...
INSERT INTO datos (id_contacto, telefono, mail)
VALUES
    (1006, '555-5943', 'contacto1006@example.com'),
    (1007, '555-5944', 'contacto1007@example.com'),
    (1008, '555-5945', 'contacto1008@example.com'),
    (1009, '555-5946', 'contacto1009@example.com');
...
INSERT INTO datos (id_contacto, telefono, mail)
VALUES
    (1011, '555-4947', 'contacto1010@example.com'),
    (1012, '555-5948', 'contacto1011@example.com'),
    (1013, '555-5949', 'contacto1012@example.com'),
    (1014, '555-5950', 'contacto1013@example.com');
